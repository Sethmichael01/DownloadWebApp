    ...
    public partial class WebForm2 : System.Web.UI.Page
    {
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "Download")
            {
                ...
                Response.TransmitFile(Server.MapPath("~/100LawDP/") + e.CommandArgument);
                Response.End();
            }
        }
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            {
                FileUpload1.PostedFile.SaveAs(Server.MapPath("~/100LawDP/") + FileUpload1.FileName);
            }
            DataTable dd = new DataTable();
            dd.Columns.Add("File", typeof(string));
            dd.Columns.Add("Size", typeof(string));
            dd.Columns.Add("Type", typeof(string));
            foreach (string strFiles in Directory.GetFiles(Server.MapPath("~/100LawDP/")))
            {
